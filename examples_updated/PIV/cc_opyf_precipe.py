...
# XB 4/9/2022
# CCPIV on GPU used for initial PIV (oflow2d)
# modified Brox 2004 optical flow for refinement (refine2dof_whole)
# for selected planes (18-24)
# Full image in rbndx considered for both
# gpu enabled for oflow2d
# but all epoches procressed in serial
# since multiprocessing is off
