...
# XB 4/9/2022
# CCPIV on GPU used for initial PIV (oflow2d) and refinement (refine2dof)
# Full image in rbndx considered for both
# "gpu" in pivdict and "GPU"&"multiprocessing" in conf_loop_epoch needed
# for parallel hybrid CPU/GPU PIV
import os
...
high_res = False
pivdict={
    'gpu': True,#use non-zero bolap when openpiv is used!
    'high_res': high_res,
    'gp_rbndx':rbndx,
    'gp_bsize':(32,32),
    'gp_bolap':(16,16),
...
conf_refine2dof = {'pivdict':rpivdict,
                   ...
                   #'crbndx':crbndx,#full img
                   'rfactor':1.2,
                   'its':2,
                   'eps':0.01,
                   #'planes':range(18,25),#full planes,not effective for refine2dof_whole
