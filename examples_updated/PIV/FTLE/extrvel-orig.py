...
# >>>>> SETUP <<<<<                                                             
pdifname  = "../PIVDATA-SYNC.ex2"    # Input file for PIVData object.
pdofname  = "ORIG-PLNRVEL.ex2"           # Output file name for PIVData object.
velkey    = "U-MF"         # Velocity key for vort, divrg, trace.
