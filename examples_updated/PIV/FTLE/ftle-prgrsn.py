...
epslc    = slice(3,59)                  # Epoch slice for processing.
direc    = -1
eplim    = [0,58] 
ntrpc    = [2,4,4]                      # Number of tracers per cell per call.
ncalls   = 1                            # Number of calls. >1 not implemented in FTLE core lib.
irspath  = "FTLETRACE-BWD-NOBACKUP"     # Intermidate results output path.
pdofname = "FTLEFIELD-BWD.ex2"          # Output file for PIVData object.
