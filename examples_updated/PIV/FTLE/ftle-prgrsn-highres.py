...
direc    = -1
eplim    = [0,6] 
ntrpc    = [2,8,8]                      # Number of tracers per cell per call.
ncalls   = 1                            # Number of calls. >1 not implemented in FTLE core lib.
irspath  = "HIGHRES-FTLETRACE-BWD-NOBACKUP"     # Intermidate results output path.
pdofname = "HIGHRES-FTLEFIELD-BWD.ex2"          # Output file for PIVData object.
